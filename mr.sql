...
CREATE TABLE "tblComment" ("ID" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "PID" INTEGER, "Timestamp" DATETIME, "Comment" TEXT);
...
CREATE TABLE "tblDuty" ("ID" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "PersID" INTEGER NOT NULL , "TypeID" INTEGER NOT NULL , "DDate" DATETIME NOT NULL , "Status" BOOL , "TimeFrom" DATETIME, "TimeTo" DATETIME, "TimeFrom2" DATETIME, "TimeTo2" DATETIME, "Dura" DATETIME, "Dura2" DATETIME);
CREATE TABLE "tblDutyTypes" ("ID" INTEGER PRIMARY KEY  NOT NULL ,"Mark" VARCHAR NOT NULL ,"Decr" VARCHAR NOT NULL ,"TimeFrom" DATETIME NOT NULL ,"TimeTo" DATETIME NOT NULL ,"TimeElapsed" DATETIME NOT NULL ,"MinOffBefore" DATETIME NOT NULL ,"MinOffAfter" DATETIME NOT NULL , "ColorR" INTEGER NOT NULL  DEFAULT 255, "ColorG" INTEGER NOT NULL  DEFAULT 255, "ColorB" INTEGER NOT NULL  DEFAULT 255, "TimeFrom2" DATETIME, "TimeTo2" DATETIME, "TimeElapsed2" DATETIME, "BaseType" INTEGER, "Sequence" INTEGER);
CREATE TABLE "tblHolidays" ("ID" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "iDay" INTEGER, "iMonth" INTEGER, "mvbl" BOOL, "Descr" VARCHAR);
...
CREATE TABLE "tblPersonal" ("ID" INTEGER PRIMARY KEY  NOT NULL ,"Name" VARCHAR NOT NULL ,"VName" VARCHAR NOT NULL ,"PNr" VARCHAR NOT NULL ,"GebDat" DATETIME NOT NULL ,"SollTag" DATETIME NOT NULL ,"Eintritt" DATETIME NOT NULL ,"Austritt" DATETIME NOT NULL ,"PlanEdit" BOOL,"Admin" BOOL,"BreakDate" DATETIME, "BDdiff" DOUBLE DEFAULT 0.0);
